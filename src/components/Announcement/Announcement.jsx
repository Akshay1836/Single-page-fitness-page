...
const Announcement = () => {
  return (
    <div class="mx-auto max-w-screen-lg bg-violet-800 p-8 my-16 text-white md:flex md:items-center md:justify-around md:p-16 lg:rounded-xl">
      ...
      <div class="whitespace-nowrap">
        <button class="focus:outline-4 rounded-xl bg-yellow-400 px-4 py-3 font-medium text-white shadow-md outline-white transition hover:bg-yellow-500">
          Try these now
        </button>
      </div>
    </div>
